...
namespace UnityStandardAssets._2D
{
    public class PlatformerCharacter2D : MonoBehaviour
    {
        ...
        [SerializeField] private AudioClip audioLend;
        ...
        private void PlaySound(AudioClip clip)
        {
            ...
            if (!findFreeSource)
            {
                ...
                newAudioSource.volume = audioSources[0].volume;
                newAudioSource.Play();
            }
        }
        ...
        {
            int numAudio = Random.Range(0, audioSteps.Length);
            PlaySound(audioSteps[numAudio]);
        }
